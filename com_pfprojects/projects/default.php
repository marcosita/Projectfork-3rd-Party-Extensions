...
$jsoeverride = JURI::base() . 'templates/' . JFactory::getApplication()->getTemplate().'/html/com_pfprojects/js/jquery.cookie.js';
$doc->addScript($jsoeverride);
$doc->addScriptDeclaration('
jQuery(document).ready(function() {	
	if (jQuery.cookie("filter_mine") == 1) {
		jQuery("#filter_mine").attr("checked","checked");
		filterMine();
	}
});
');
        ...
        <form name="adminForm" id="adminForm" action="<?php echo JRoute::_(PFprojectsHelperRoute::getProjectsRoute()); ?>" method="post">
            ...
            <div class="<?php echo $filter_in;?>collapse" id="filters">
                <div class="btn-toolbar clearfix">
                    ...
                    <?php endif; ?>
					<div class="checkbox pull-left"><label for="filter_mine">Filter Own<input type="checkbox" id="filter_mine" name="filter_mine" value="" onchange="filterMine()"></label></div>
                </div>
            </div>
            ...
            <div class="row-striped">
                ...
                <?php $current_cat = $item->category_title; endif; ?>
                	<div class="row-fluid <?php echo $mine; ?>">
    	    	    	<div class="span7">
...
function filterMine(){
	var val;
	if (jQuery("#filter_mine").is(':checked')){
		jQuery( ".notmine" ).hide();
		val = 1;
	}else {
		jQuery( ".notmine" ).show();
