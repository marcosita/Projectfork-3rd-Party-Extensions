...
$jsoeverride = JURI::base() . 'templates/' . JFactory::getApplication()->getTemplate().'/html/com_pfmilestones/js/jquery.PrintArea.js';
$doc->addScript($jsoeverride);
$doc->addScriptDeclaration('
jQuery(document).ready(function()
{
	jQuery("div#print_btn").click(function(){
		jQuery(".PrintArea.all").printArea();
	});
});
');
    ...
    <div class="cat-items">
        <form name="adminForm" id="adminForm" action="<?php echo JRoute::_(PFmilestonesHelperRoute::getMilestonesRoute()); ?>" method="post">
            <div class="btn-toolbar btn-toolbar-top">
				...
				<div class="btn button b1" id="print_btn">Print</div>
            </div>
