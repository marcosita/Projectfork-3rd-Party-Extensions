...
(function($) {
    ...
    function getHead()
    {
		...
		//now let's get the dynamically generated inline css styles. Can't seem to find an approach that'll limit it to just those associated with mod_pf_gantt
		$(document).find("style")
			.each(function() {
				inline += $(this).html();
			});
        return "<head><title>" + settings.popTitle + "</title>" + extraHead + links + "<style>" + inline +"</style></head>";
    }
